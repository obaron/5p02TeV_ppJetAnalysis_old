...
void printJetQAHist( TFile* finData , TFile* finMC, int j, bool doJetIDPlots,
  ...
  if(var[j]=="jtpt_forRes" || var[j]=="jtpt_L2Res" || var[j]=="jtpt_L3Res"){ //constructs string for MC input histograms
...
void printJetIDHist( TFile* fin , int j, bool isData,
 ...
 std::cout<<"jtetaLoCut_str = "<<jtetaLoCut_str<<std::endl;
  ...
  std::string inHistName="hJetQA_0wJetID_"+var[j]; //gets data hist input name
